...
<body>
    ...
    <div class="container" style="margin-top:20px">
        ...
        <button class="btn btn-primary btn-md" onclick="window.location.href='Tambah.php'"> Tambah Baru </button> <center><center><h2>Daftar Mahasiswa</h2></center>
                    ...
                    while($data = mysqli_fetch_assoc($sql)){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus.php?id='.$data['id'].'" class="btn btn-info" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
                            </td>
                        </tr>
                        ';
                        $no++;
